...
public record GameVideoCfgSectionStateView : ICustomConfigState
{
    ...
    public GameCfgSection[] RetrieveCurrentSettings()
    {
        M2TWGameCfgOption[] videoCfgOptions =
        {
            ...
            new (name: VideoBloomTextId, value: this.VideoBloom!.IntegerValue, section: VideoConfigSwitch),
            ...
            new (name: VideoSkipMipLevelsTextId, value: this.VideoSkipMipLevels!.IntegerValue, section: VideoConfigSwitch),
