...
public record ModGameplaySectionStateView : ICustomConfigState
{
    ...
    public GameCfgSection[] RetrieveCurrentSettings()
    {
        M2TWGameCfgOption[] gameCfgOptions =
        {
            ...
            new (name: GameBlindAdvisorTextId, value: this.GameBlindAdvisor!.BooleanValue, section: GameConfigSwitch),
            new (name: GameCampaignMapGameSpeedTextId, value: this.GameCampaignMapGameSpeed!.Value, section: GameConfigSwitch),
            new (name: GameCampaignMapSpeedUpTextId, value: this.GameCampaignMapSpeedUp!.Value, section: GameConfigSwitch),
            new (name: GameCampaignNumTimePlayTextId, value: this.GameCampaignNumTimePlay!.Value, section: GameConfigSwitch),
            new (name: GameChatMsgDurationTextId, value: this.GameChatMsgDuration!.Value, section: GameConfigSwitch),
            new (name: GameDisableArrowMarkersTextId, value: this.GameDisableArrowMarkers!.BooleanValue, section: GameConfigSwitch),
            new (name: GameDisableEventsTextId, value: this.GameDisableEvents!.BooleanValue, section: GameConfigSwitch),
            new (name: GameEnglishTextId, value: this.GameEnglish!.BooleanValue, section: GameConfigSwitch),
            new (name: GameEventCutscenesTextId, value: this.GameEventCutscenes!.BooleanValue, section: GameConfigSwitch),
            new (name: GameFatigueTextId, value: this.GameFatigue!.BooleanValue, section: GameConfigSwitch),
            new (name: GameFirstTimePlayTextId, value: this.GameFirstTimePlay!.BooleanValue, section: GameConfigSwitch),
            new (name: GameGamespySavePasswrdTextId, value: this.GameGamespySavePasswrd!.BooleanValue, section: GameConfigSwitch),
            new (name: GameLabelCharactersTextId, value: this.GameLabelCharacters!.BooleanValue, section: GameConfigSwitch),
            new (name: GameLabelSettlementsTextId, value: this.GameLabelSettlements!.BooleanValue, section: GameConfigSwitch),
            new (name: GameMicromanageAllSettlementsTextId, value: this.GameMicromanageAllSettlements!.BooleanValue, section: GameConfigSwitch),
            new (name: GameMoraleTextId, value: this.GameMorale!.BooleanValue, section: GameConfigSwitch),
            new (name: GameMuteAdvisorTextId, value: this.GameMuteAdvisor!.BooleanValue, section: GameConfigSwitch),
            new (name: GameNoCampaignBattleTimeLimitTextId, value: this.GameNoCampaignBattleTimeLimit!.BooleanValue, section: GameConfigSwitch),
            new (name: GamePrefFactionsPlayedTextId, value: this.GamePrefFactionsPlayed!, section: GameConfigSwitch),
            new (name: GameTutorialBattlePlayedTextId, value: this.GameTutorialBattlePlayed!.BooleanValue, section: GameConfigSwitch),
            new (name: GameTutorialPathTextId, value: this.GameTutorialPath!, section: GameConfigSwitch),
            new (name: GameUnitSizeTextId, value: this.GameUnitSize!.Value, section: GameConfigSwitch),
            new (name: GameUnlimitedMenOnBattlefieldTextId, value: this.GameUnlimitedMenOnBattlefield!.BooleanValue, section: GameConfigSwitch),
            new (name: GameUseQuickchatTextId, value: this.GameUseQuickchat!.BooleanValue, section: GameConfigSwitch),
        };
